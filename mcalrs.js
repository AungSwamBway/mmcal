...
function rmDisp() {
	...
	do {
		...
		else if (rmcalLang == "my-Kar" || rmcalLang == "my-kar") rLang = 5; //Karen language
...
function rj2m(jd) {
	...
	return {
		my: my, myt: yo.myt, watat: yo.watat, bw: yo.bw, myl: myl, mm: mm, mmt: mmt,
...
function rSetLang(lang) //Internationalization---------------------------------
{
	if (lang == 0) { //Catalog for  English Language
		return {
			'First Waso': 'First Waso', 'Tagu': 'Tagu', 'Kason': 'Kason',
		...
		return {
			'First Waso': 'ဂိတုပ-ဒ္ဂိုန်', 'Tagu': 'ဂိတုစဲ', 'Kason': 'ဂိတုပသာ်', 'Nayon': 'ဂိတုဇှေ်',
		...
		return {
			'First Waso': 'ပဝါဆို', 'Tagu': 'တန္ခူး', 'Kason': 'ကဆုန္', 'Nayon': 'နယုန္',
		...
		return {
			'First Waso': 'ပဝါႏဆိုႏ', 'Tagu': 'ဒဲဉ်ဟား', 'Kason': 'ဒဲဉ်ရုတ်ꩻ', 'Nayon': 'ဒဲဉ်စေတ်ꩻ',
		...
		return {
			'First Waso': 'ပဝါဆို', 'Tagu': 'တန်ခူး', 'Kason': 'ကဆုန်', 'Nayon': 'နယုန်',
